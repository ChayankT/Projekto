...
- **Sprint Detail** (`/projects/:id/sprints/:sprintId`) — a single sprint's drag-and-drop board plus its task-based burndown chart and task-completion totals (not story points — see "Sprints & Burndown" below).
